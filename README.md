...
The following example deploy an `hello` application on teh deployment group `development` after pushed the application on the `apps.mycompany.com` S3 bucket :
